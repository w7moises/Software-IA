...
randomWall(0, 0, False)
randomWall(1, 1, False)
randomWall(48, 48, False)
randomWall(49, 49, False)
start = grid[0][0]
end = grid[49][49]
    ...
    while True:
        ...
        if startflag:
            if len(openSet) > 0:
                ...
                if noflag:
                    Tk().wm_withdraw()
                    messagebox.showinfo("No hay solucion", "No habia solucion")
                    noflag = False
